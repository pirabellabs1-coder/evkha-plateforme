...
Visuel 2 — Graphique comparatif des parts de marche ou de visibilite : une figure de type `barres_horizontales` ou `camembert`, acteurs dominants et emergents, position du projet si pertinent.
Visuel 3 — Diagramme radar des forces / faiblesses : une figure de type `radar`, les 11 acteurs evalues sur 5 a 6 axes cles (qualite, prix, innovation, RSE, experience client, notoriete). Grille strictement identique pour les directs et les indirects ; si la lisibilite l'impose, scinde en deux radars sur les MEMES axes.
Visuel 4 — Répartition des canaux de communication : une figure de type `barres_verticales` ou un tableau structure, comparatif par canal (digital, terrain, bouche-a-oreille, presse, reseaux sociaux, partenariats), par concurrent ou par categorie d'acteur.
