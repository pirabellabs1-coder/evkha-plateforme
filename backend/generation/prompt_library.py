...
MARKET_STUDY_PROMPTS: dict[str, str] = {
    ...
    "em.18.swot": (
        ...
        "<!-- liste des forces : 5 a 7 points concrets et argumentes --></td>"
        "<td style=\"vertical-align:top;padding:3mm;border:0.5pt solid #EFEAD8\">"
        "<!-- liste des faiblesses : 4 a 6 points --></td>"
        "</tr>\n"
        "<tr>"
        ...
        "<tr>"
        "<td style=\"vertical-align:top;padding:3mm;border:0.5pt solid #EFEAD8\">"
        "<!-- liste des opportunites : 5 a 7 points --></td>"
        "<td style=\"vertical-align:top;padding:3mm;border:0.5pt solid #EFEAD8\">"
        "<!-- liste des menaces : 4 a 6 points --></td>"
        "</tr>\n"
        "</table>\n"
        "Dans chaque cellule : liste <ul><li> avec puces. Chaque point = 1 a 2 phrases "
        "concretes et chiffrees si possible. "
