...
MARKET_STUDY_PROMPTS: dict[str, str] = {
    ...
    "em.22.sources": (
        ...
        "SOURCES_WEB du contexte (titre + URL) ; n'invente aucune reference "
        "absente de ce bloc. Si aucune source web n'a ete fournie, indique les "
        "references documentaires effectivement mobilisees sans fabriquer "
