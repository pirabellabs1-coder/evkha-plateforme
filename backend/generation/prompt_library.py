...
MARKET_STUDY_PROMPTS: dict[str, str] = {
    ...
    "em.04.avantages_inconvenients": (
        ...
        "Visuel utile : encadre comparatif ou balance avantages/contraintes."
    ),
    "em.05.defis_opportunites": (
        ...
        "Visuel utile : matrice impact/horizon des defis et opportunites."
    ),
    ...
    "em.09.douze_chiffres_cles": (
        ...
        "Visuel utile : tuiles chiffrees ou tableau synthetique lisible. Si tu "
        "produis un graphique, utilise un bloc ```chart de type 'bar' avec 5 a "
        "7 chiffres homogenes en unite (labels courts max 3 mots, values "
        "numeriques pures, unit dans le champ 'unit')."
    ),
    ...
    "em.19.a.diagnostic": (
        "SECTION 19.a — Position du projet face au marche et niveau de "
        "differenciation (manuel §6 ch. 19, p. 16).\n"
        ...
        "Contenu obligatoire :\n"
        "- 3 a 5 enseignements majeurs de l'etude, cites depuis les "
        "chapitres precedents (« comme etabli au ch. X »).\n"
        "- Lecture de la position du projet face au marche : force "
        "relative, avantage differenciant, gaps a combler.\n"
        "- Risques critiques a traiter en priorite (extraits du ch. 12 et "
        "de la cartographie ch. 13).\n"
        "- 2 a 3 tensions ou arbitrages a resoudre avant lancement.\n"
    ...
    "em.19.b.plan_action": (
        ...
        "Contenu obligatoire :\n"
        "- 5 a 7 recommandations, hierarchisees. Chacune indique : quoi "
        "faire, pourquoi (justification issue de l'etude), horizon "
        "(0-6 mois / 6-24 mois / > 24 mois), et 1 indicateur mesurable qui "
        "prouvera le succes.\n"
        "- 1 signal d'alerte a surveiller absolument dans les 90 jours qui "
