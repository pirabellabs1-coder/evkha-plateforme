...
_CHARTER = (
    ...
    "\n"
    "[FORMAT DES NOMBRES — regle lot 87]\n"
    "Convention francaise obligatoire dans tout le document :\n"
    "- virgule decimale : 16,5 (jamais 16.5)\n"
    "- espace insecable comme separateur de milliers : 320 000 (jamais "
    "320,000 ni 320000)\n"
    "- symbole monetaire APRES le nombre : 320 000 EUR, 16,5 Md EUR, "
    "600 k EUR (jamais EUR320 000)\n"
    "- pourcentage colle : 3,4 %\n"
    "Aucune notation scientifique (jamais 1.6e+10). Un nombre de plus "
    "de neuf chiffres utilise une magnitude : 16,5 Md EUR, 3,3 M EUR.\n"
    "\n"
    ...
    "restent couvertes.\n"
    "ACTUEL vs OBJECTIF : distingue clairement ce qui EXISTE (la plateforme "
    "est en ligne, 8 000 lieux referencies, la marque est deposee) de ce qui "
    "est VISE (10 000 utilisateurs a 12 mois, 200 professionnels partenaires). "
    "Ne pas presenter un objectif au present de l'indicatif comme s'il etait "
    "deja atteint.\n"
    "CHRONOLOGIE UNIQUE : la date de creation, l'annee des investissements et "
    "l'exercice 1 forment une seule ligne de temps coherente. Un investissement "
    "ne peut pas preceder la creation de l'entreprise. L'exercice 1 commence "
    "apres la creation. Utiliser les memes dates d'un chapitre a l'autre.\n"
    "\n"
...
def _consigne_specifique_livrable(deliverable_type: str) -> str:
    ...
    if deliverable_type == DeliverableType.COMPETITOR_STUDY:
        ...
        return (
            ...
            f"d'égalité.\n"
            "TARIFS PUBLIÉS (règle absolue, lot 85) : n'écris JAMAIS « sur "
            "devis » ni « tarifs non communiqués » lorsqu'un prix est "
            "trouvable en ligne (site officiel, annuaire, comparateur, "
            "plateforme de réservation, avis mentionnant un prix). Cherche le "
            "tarif réel. Si, après recherche, aucun prix n'est disponible "
            "nulle part, écris « prix non publié en ligne au [date du jour] » "
            "en remplaçant [date du jour] par la date réelle — jamais "
            "« sur devis ».\n"
            "AVIS ET TÉMOIGNAGES (règle absolue) : pour chaque concurrent, "
            "cherche activement les avis clients (Google, Trustpilot, "
            "réseaux sociaux, forums). Indique le nombre d'avis et la note "
            "moyenne quand ils existent. Ne dis JAMAIS qu'un concurrent n'a "
            "pas d'avis sans avoir vérifié.\n"
            "COUVERTURE DES VERTICALES (règle absolue) : si le client "
            "propose plusieurs univers, gammes ou verticales d'activité, "
            "le benchmark DOIT couvrir chacune d'entre elles. Chaque "
            "concurrent est évalué sur sa pertinence pour chaque verticale "
            "du client, pas uniquement sur l'activité principale.\n"
            "NOTATION DU CLIENT (règle absolue) : le projet du client "
            "n'est PAS encore commercialisé (sauf mention contraire dans le "
            "brief). Ne le note JAMAIS comme un acteur en activité. Présente "
            "ses scores comme « positionnement cible à valider lors du "
            "pilote » ou « objectif de lancement ». Les matrices comparatives "
            "doivent distinguer clairement les acteurs en activité des "
