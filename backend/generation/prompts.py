...
_CHARTER = (
    ...
    "'sectoriel' invérifiable. Quand une donnee precise n'est pas etablie, "
    "produire une estimation argumentee EXPLICITEMENT presentee comme telle "
    "('estimation construite a partir de...', avec le raisonnement), jamais "
    "presentee comme un fait source. Si aucune source recente fiable "
    "n'existe, le dire explicitement plutot que d'en fabriquer une.\n"
